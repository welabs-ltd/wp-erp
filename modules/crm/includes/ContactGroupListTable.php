...
class ContactGroupListTable extends WP_List_Table {
    ...
    public function column_name( $contact_group ) {
        ...
        if ( current_user_can( 'erp_crm_edit_groups' ) && apply_filters('erp_crm_allow_edit_contact_group', true ) === true ) {
        ...
        if ( current_user_can( 'erp_crm_edit_groups' ) && apply_filters('erp_crm_allow_delete_contact_group', true ) === true ) {
